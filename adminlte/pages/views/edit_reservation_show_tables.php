...
<head>
    ...
    <title>Kukła | Wybór stolika</title>
...
<div class="wrapper">
    ...
    <?php
    require_once "./$role_path/edit_reservation_show_tables/edit_reservation_show_tables_aside.php";
    ?>

    <!-- Content Wrapper. Contains page content -->
    <?php
    require_once "./$role_path/edit_reservation_show_tables/edit_reservation_show_tables_content.php";
    ?>

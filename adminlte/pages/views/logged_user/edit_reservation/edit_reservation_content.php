...
ERROR;
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edycja rezerwacji o identyfikatorze: <?php echo $_SESSION["edit_reservation"] ?> </h1>
                </div>
                <div class="col-sm-6">
...
<!--                            </div>-->
                            ...
                            <form action="../../scripts/edit_reservation_show_tables.php" method="POST">
                                <input type="hidden" name="edit_reservation" value="<?php echo $_SESSION["edit_reservation"] ?>">

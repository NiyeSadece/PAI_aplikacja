...
try {
    ...
    $stmt->bind_param("iiisss", $_SESSION["logged"]["restaurantId"], $_SESSION["logged"]["userID"], $_SESSION["logged"]["table_id"], $_SESSION["logged"]["reservationDate"], $_SESSION["logged"]["startTime"], $_SESSION["logged"]["endTime"]);
